...
; (function ($, window, document, Util, undefined) {
    ...
    Images2.prototype.init = function () {
    ...
    Images2.prototype.events = function () {
        $(document)
    ...
    Images2.prototype.backwardsCompatibility = function () {
    ...
    Images2.prototype.editorSerialize = function () {
    ...
    Images2.prototype.uploadAdd = function (e, data) {
    ...
    Images2.prototype.uploadProgressall = function (e, data) {
        var progress, progressbar;

        if (this.options.preview === false) {
            progress = parseInt(data.loaded / data.total * 100, 10);
            // $progressbar = this.$el.find('#p1');
    ...
    Images2.prototype.getDOMImage = function () {
    ...
    Images2.prototype.unselectImage = function (e) {
        var $el = $(e.target),
    ...
    Images2.prototype.removeImage = function (e) {
        var images = [],
    ...
    Images2.prototype.deleteFile = function (file) {
    ...
    Images2.prototype.addToolbar = function () {
    ...
    Images2.prototype.autoRepositionToolbars = function () {
        setTimeout(function () {
            this.repositionToolbars();
            this.repositionToolbars();
        }.bind(this), 0);
    ...
    Images2.prototype.repositionToolbars = function () {
    ...
    Images2.prototype.toolbarAction = function (e) {
        var that = this,
            $button, $li, $ul, $lis, $p;
    ...
    Images2.prototype.toolbar2Action = function (e) {
        var $button, callback;
    ...
    $.fn[pluginName + addonName] = function (options) {
        return this.each(function () {
            if (!$.data(this, 'plugin_' + pluginName + addonName)) {
                $.data(this, 'plugin_' + pluginName + addonName, new Images2(this, options));
            }
        });
    };
