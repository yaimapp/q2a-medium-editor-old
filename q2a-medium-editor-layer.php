...
class qa_html_theme_layer extends qa_html_theme_base
{
    ...
    const JS_EM_VERSION = '1.0.0';
    const JS_VI_VERSION = '1.0.0';
    const JS_ED_VERSION = '1.0.0';
    const JS_OV_VERSION = '1.0.0';
    const JS_IM_VERSION = '1.0.1';
    const JS_UT_VERSION = '1.0.0';
    ...
    public function head_script()
    {
        ...
        if (in_array($this->template, $allow_templates)) {
            $this->output('<link rel="stylesheet" type="text/css" href="'.QA_HTML_THEME_LAYER_URLTOROOT.'css/custom.css?ver='.self::CSS_VERSION.'" />');
        }
    }
    ...
    private function output_js()
    {
        ...
        $this->output('<script src="'.QA_HTML_THEME_LAYER_URLTOROOT.'js/q2a-embeds.js?ver='.self::JS_EM_VERSION.'"></script>');
        $this->output('<script src="'.QA_HTML_THEME_LAYER_URLTOROOT.'js/q2a-videos.js?ver='.self::JS_VI_VERSION.'"></script>');
        $this->output('<script src="'.QA_HTML_THEME_LAYER_URLTOROOT.'js/q2a-editor.js?ver='.self::JS_ED_VERSION.'"></script>');
        $this->output('<script src="'.QA_HTML_THEME_LAYER_URLTOROOT.'js/override.js?ver='.self::JS_OV_VERSION.'"></script>');
        $this->output('<script src="//assets.transloadit.com/js/jquery.transloadit2-v2-latest.js"></script>');
        if (strpos(qa_opt('site_theme'), 'q2a-material-lite') !== false) {
            $this->output('<script src="'.QA_HTML_THEME_LAYER_URLTOROOT.'js/q2a-images.js?ver='.self::JS_IM_VERSION.'"></script>');
        }
    }
    ...
    private function output_js_warn()
    {
      ...
      $script = QA_HTML_THEME_LAYER_URLTOROOT.'js/medium-editor-util.js?ver='.self::JS_UT_VERSION;
      $script_mobile = QA_HTML_THEME_LAYER_URLTOROOT.'js/medium-editor-util-mobile.js?ver='.self::JS_UT_VERSION;
      $this->output('<script>');
